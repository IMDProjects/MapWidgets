...
<body>
    <div id="wrapper">
        <div id="page" class="clearfix">	
            ...
            <p>Select your network and zoom to an area of interest within it.  Click on a quarter quad feature to view quad name. 
			If additional quads are desired, click on a point, copy the quad name(s), then click the Email Quad Request link.</p>
			<div>
